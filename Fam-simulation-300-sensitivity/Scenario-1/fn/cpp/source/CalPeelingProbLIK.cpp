/*
 * CalPeelingProbLIK.cpp
 *
 *  Created on: Oct 14, 2013
 *      Author: gpeng1
 */

//#include "CalPeelingProbLIK.h"
#include "R.h"
...
extern "C"{
	void CalPeelingProbLIK(double* genoprob, double* likelihood, int* id, int* gender, int* fid, int* mid, int* nSample, int* cid, int* ncid, int* nloci, int* nAllele, double* mrate, double* posteriorprob, double* lik){
		int nGeno = 1;
		...
		*/
	    ...
	    dMatrix<double> postProb = mendel.calPostProbLIK(lk,sampleID,pedLIK);
